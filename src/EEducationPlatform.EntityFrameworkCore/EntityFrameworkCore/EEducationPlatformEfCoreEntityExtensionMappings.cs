...
public static class EEducationPlatformEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE EEducationPlatformModuleExtensionConfigurator CLASS (in the Domain.Shared project)
